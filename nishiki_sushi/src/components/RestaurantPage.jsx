        ...
        <main id="restaurant-page-main">
          <div id="restaurant-grid-intro">
            <section id="restaurant-intro-section">
              ...
              <div>
                <p>
                  Besøg os i hjertet af Frederikssund. Vi sætter en ære i altid
                  at tilbyde friske råvarer og lækre specialiteter i top
                  kvalitet til gode priser.
                </p>
                <p>
                  Prøv vores populære ad libitum menu fra kun 199kr eller bestil
                  ala carte fra vores mange sushi varianter, lækre forreter
                  eller sticks.
                </p>
              </div>
