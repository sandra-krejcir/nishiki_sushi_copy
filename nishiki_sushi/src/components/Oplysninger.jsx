          ...
          <form onSubmit={handleSubmit} id="oplysninger_form">
            <div className="from_name_time_number">
              <div>
                ...
                <input style={{ border: errors.oplysninger_navn ? "2px solid red" : "" }} onChange={handleChange} value={values.oplysninger_navn} type="text" name="oplysninger_navn" id="oplysninger_navn" minLength="2" placeholder="John Doe" />
              ...
              <div>
                ...
                <input style={{ border: errors.oplysninger_tid ? "2px solid red" : "" }} onChange={handleChange} value={values.oplysninger_tid} type="time" id="oplysninger_tid" name="oplysninger_tid" min="15:00" max="21:00" />
              ...
              <div>
                ...
                <input
                  style={{ border: errors.oplysninger_mobil ? "2px solid red" : "" }}
