...
const CateringFormStep1 = ({ submitForm }) => {
  ...
  return (
    <div>
      <h3>Få et tilbud</h3>
      <p>
        Send os en beskrivelse af din drømmefest. Husk at skrive hvornår eventet
        skal afholdes, antal gæster og og andre specifikke ønsker til dit event.
        Vi kontakter dig via din email adresse med et tilbud på en samlet pris
        inde for 2-3 dage.
      </p>
      <form onSubmit={handleSubmit} className="cateringForm_container">
        ...
        >
          NAVN
          <input
            style={{ border: errors.enquiryName ? "2px solid red" : "" }}
            onChange={handleChange}
            value={values.enquiryName}
            type="text"
            id="enquiryName"
            name="enquiryName"
          ...
          ></input>
          {errors.enquiryName && (
            <p className="errorMessage">{errors.enquiryName}</p>
          )}
        </label>
        ...
        >
          ...
          <input
            style={{
              border: errors.enquiryEmailAddress ? "2px solid red" : "",
            }}
            onChange={handleChange}
            value={values.enquiryEmailAddress}
            type="email"
            id="enquiryEmailAddress"
            name="enquiryEmailAddress"
            placeholder="Johndoe@mail.com"
          ></input>
          {errors.enquiryEmailAddress && (
            <p className="errorMessage">{errors.enquiryEmailAddress}</p>
          )}
        </label>
        ...
        >
          ...
          <select
            onChange={handleChange}
            value={values.enquiryFestType}
            type="text"
            id="enquiryFestType"
            name="enquiryFestType"
          >
        ...
        >
          EVENT BESKRIVELSE
          <textarea
            style={{ border: errors.enquiryComment ? "2px solid red" : "" }}
            onChange={handleChange}
            value={values.enquiryComment}
            id="enquiryComment"
            name="enquiryComment"
          ></textarea>
          {errors.enquiryComment && (
            <p className="errorMessage">{errors.enquiryComment}</p>
          )}
        </label>
